...
if __name__ == "__main__":
    ...
    sampled_epochs,losses_train,losses_dev = train_part(Parameters.N_EPOCHS,Parameters.CLIP,Parameters.PATIENCE,dev_loader,train_loader,test_loader,lang,optimizer,Parameters.CRITERSION_SLOTS,Parameters.CRITERSION_INTENTS,model)

    eval_part(Parameters.CRITERSION_SLOTS,Parameters.CRITERSION_INTENTS, load_eval_model(Parameters.DEVICE),test_loader,lang)
